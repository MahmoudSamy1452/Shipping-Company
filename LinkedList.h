...
public:
	...
	@post if true, passed object has been modified
	@param position The list position of the desired entry, object passed by reference
	@return True if object has been modified, false otherwise. */
